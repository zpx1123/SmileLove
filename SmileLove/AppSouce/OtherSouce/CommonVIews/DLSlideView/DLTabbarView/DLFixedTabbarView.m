    ...
    if (_tabbarItems != tabbarItems) {
        ...
        for (DLFixedTabbarViewTabItem *item in tabbarItems) {
            ...
            if (i==0) {
                ...
                lineView.size=CGSizeMake(0, 0);
                lineView.tag=kViewTagBase+i;
                lineView.backgroundColor=[UIColor grayColor];
            }else{

                lineView.size=CGSizeMake(0.8, height-6);
                lineView.tag=kViewTagBase+i;
                lineView.backgroundColor=[UIColor grayColor];
            }
            ...
            [scrollView_ addSubview:lineView];
            i++;
        }
...
- (void)layoutTabbar{
    ...
    for (NSInteger i=0; i<self.tabbarItems.count; i++) {
        ...
        UIView *lineView = (UIView *)[scrollView_ viewWithTag:kViewTagBase+i];
        lineView.left=x;
