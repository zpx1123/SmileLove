...
//    UILabel *titleLabel = (UILabel*)[cell viewWithTag:1];
    ...
    if (leftOrRight == 1) {
        ...
        titleLabel.frame = CGRectMake(20, 0, textSize.width, cell.frame.size.height);
...
//                accessoryImageView.frame = CGRectMake(titleLabel.frame.origin.x+titleLabel.frame.size.width+10, (self.frame.size.height-12)/2, 16, 12);
                accessoryImageView.frame = CGRectMake(self.frame.size.width-20, (self.frame.size.height-12)/2, 16, 12);
