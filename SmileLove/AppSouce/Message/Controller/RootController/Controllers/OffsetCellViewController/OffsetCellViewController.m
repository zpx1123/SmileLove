...
- (void)setup {
    ...
    [[WDHttpRequest creatNetRequest]startWithRequest:baserequest downloadProgress:nil success:^(WDBaseRequest *request) {
        ...
        WanDouJiaModel * aaa=[[WanDouJiaModel alloc] initWithDictionary:request.responseJSONObject];
        self.rootModel= [[WanDouJiaModel alloc] initWithDictionary:request.responseJSONObject];
        //        return ;
...
//    self.showLoadingView.backgroundColor=[UIColor clearColor];
