...
-(void)loadView
{
    ...
    self.view = scrollView;
        ...
        _floatLayout.IntelligentBorderLine = [[MyBorderLineDraw alloc] initWithColor:[[UIColor lightGrayColor] colorWithAlphaComponent:1]];
    [scrollView addSubview:_floatLayout];
}
